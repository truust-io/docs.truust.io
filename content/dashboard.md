...
You can block an order to stop from releasing the payment to the seller. This dashboard functionality is very useful for transactions that may be suspicious of malpractice.
...
2. From the order page, click the **\[···]** menu on the right of one order.
