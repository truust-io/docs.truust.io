...
<CardGroup cols={3}>
  ...
  <Card
    ...
    href="/payment-methods#banktransfers"
  >
...
<CardGroup cols={3}>
  <Card
    ...
    icon="wallet"
    href="/payment-flows#walletpayments"
  >
  ...
  <Card
    ...
    icon="code-branch"
    href="/payment-flows#splitpayments"
  >
  ...
  <Card
    title="Order Status"
    icon="list-check"
    href="/payment-flows#orderstatus"
  >
